...
class TestSetPriority(unittest.TestCase):
    def test_pre_processing1(self):
        ...
        self.assertEqual(call.get_args(), [f.rpc_id, 0])

    def test_pre_processing3(self):
        call = self._get_call('normal')
        call.do_pre_processing()
        self.assertEqual(call.get_args(), [f.rpc_id, 1])

    def test_pre_processing4(self):
        call = self._get_call('high')
        call.do_pre_processing()
        self.assertEqual(call.get_args(), [f.rpc_id, 2])
...
class TestGetLastTouched(unittest.TestCase):
    ...
    def test_pre_processing(self):
        ...
        self.assertEqual(self.call.get_args(), [f.rpc_id])
...
class TestIsOpen(unittest.TestCase):
    ...
    def test_post_processing(self):
        self.assertEqual(self.call.do_post_processing(0), False)